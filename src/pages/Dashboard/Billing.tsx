...
const plans = [
  {
    ...
    features: ["Up to 2 team members", "100 properties", "Basic AI tools"],
  },
  {
    name: "Professional",
    price: "₦75,000",
    ...
    <main className="min-h-screen text-[#dae2fd] space-y-6">
      ...
      <section className="grid grid-cols-4 gap-4 ">
        ...
        <Card className="bg-[#171f33] border border-[#464554] text-[#dae2fd]">
          ...
          <CardContent>
            <p className="text-xs">You are currently on the</p>
            ...
            <div className="mt-4">
              <span className="text-xl font-semibold">₦75,000</span>
            ...
            <div className="mt-20 rounded-lg border  border-[#464554] p-3">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-xs font-medium">Mastercard •••• 4821</p>

                  <p className="text-[10px]">Expires 12/28</p>
                </div>
            ...
            <div className="mt-3 flex justify-between text-xs">
              ...
              <span className="font-medium">Sept 16, 2026</span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-[#171f33] border border-[#464554] col-span-3 text-[#dae2fd]">
          ...
          <CardContent className="space-y-5">
            {usageData.map((usage) => {
              ...
              const percentage = (usage.value / usage.limit) * 100;
              ...
              return (
                <div key={usage.label}>
                  <div className="mb-2 flex items-center justify-between">
                    ...
                    <span className="text-xs">{usage.display}</span>
                  </div>
      ...
      <section className="mt-12">
        <header className="mb-5 flex items-center justify-between">
          ...
          <div className="flex rounded-lg bg-[#171f33] border border-[#464554] p-1 text-xs">
            ...
            <button className="px-4 py-2">Yearly (Save 20%)</button>
          </div>
        </header>
          ...
          {plans.map((plan) => (
            <Card
              ...
              className={`relative   overflow-visible bg-[#171f33] border text-[#dae2fd] ${
                plan.current ? "border-2 border-[#ffb783]" : "border-[#464554] "
              }`}
            >
              {plan.current && (
                ...
                <div>
                  <span
                    className={`text-2xl font-semibold ${
                      plan.current ? "text-[#c0c1ff]" : "text-[#dae2fd]"
                    }`}
                  >
                    {plan.price}
                  </span>
